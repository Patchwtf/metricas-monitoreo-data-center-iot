...
import com.metricas_monitoreo_data_center_iot.com.service.TemperaturaService;
...
public class TemperaturaController {
    ...
    public ResponseEntity<TemperaturaEntity> registrarTemperatura(@RequestBody TemperaturaEntity temperatura) {
        try {
            ...
            log.info("Se registro la petición de cambio de temperatura a: " + nuevaTemperatura.getTemperatura());
